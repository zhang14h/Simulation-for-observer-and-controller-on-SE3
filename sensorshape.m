function  sensorgeometry = theshape(SE_3,focall,focalh,hov,vov,R,f)
        ...
        %end of sensor geometry
            plot3([SE_3(1,4),SE_3(1,4)+1*SE_3(1,1)],[SE_3(2,4),SE_3(2,4)+1*SE_3(2,1)],[SE_3(3,4),SE_3(3,4)+1*SE_3(3,1)],'--r');

            plot3([SE_3(1,4),SE_3(1,4)+1*SE_3(1,2)],[SE_3(2,4),SE_3(2,4)+1*SE_3(2,2)],[SE_3(3,4),SE_3(3,4)+1*SE_3(3,2)],'--g');
            plot3([SE_3(1,4),SE_3(1,4)+1*SE_3(1,3)],[SE_3(2,4),SE_3(2,4)+1*SE_3(2,3)],[SE_3(3,4),SE_3(3,4)+1*SE_3(3,3)],'--b');
        end;    
        if f == 2;
        ...
        % plot3(SE_3(1,:),SE_3(2,:),SE_3(3,:),'+','Color','k','MarkerSize',5);
        %end of sensor geometry
            plot3([SE_3(1,4),SE_3(1,4)+1*SE_3(1,1)],[SE_3(2,4),SE_3(2,4)+1*SE_3(2,1)],[SE_3(3,4),SE_3(3,4)+1*SE_3(3,1)],'-','color',[10 10 10]/255);

            plot3([SE_3(1,4),SE_3(1,4)+1*SE_3(1,2)],[SE_3(2,4),SE_3(2,4)+1*SE_3(2,2)],[SE_3(3,4),SE_3(3,4)+1*SE_3(3,2)],'-','color',[100 100 100]/255);
            plot3([SE_3(1,4),SE_3(1,4)+1*SE_3(1,3)],[SE_3(2,4),SE_3(2,4)+1*SE_3(2,3)],[SE_3(3,4),SE_3(3,4)+1*SE_3(3,3)],'-','color',[200 200 200]/255);
        end;
        if f == 3;
           [x,y,z] = sphere(20);
