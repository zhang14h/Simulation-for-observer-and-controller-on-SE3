...
%  y(:,1) = [0;0;1;1]; y(:,2) = [0;0;2;1]; y(:,3) = [0;0;-1;1]; y(:,4) = [0;0;-4;1]; y(:,5) = [0;1;0;1]; y(:,6) = [0;-2;0;1]; y(:,7) = [0;-3;0;1]; 
 
% y(:,1) = [1;1;1;1]; y(:,2) = [1;1;1;1]; y(:,3) = [3;2;1;1]; y(:,4)= [2;1;3;1]; y(:,5)=[1;3;2;1] ;
  
% y(:,1) = [5;4;7;1]; y(:,2) = [1;2;3;1];  y(:,3)= [2;4;6;1];
...
%        omega1(:,:,i) = -0.02*(error4(:,:,i)-eye(4))*y*y.';
       omega1(:,:,i) = -0.01*(error4(:,:,i)-eye(4))*y*y.';
